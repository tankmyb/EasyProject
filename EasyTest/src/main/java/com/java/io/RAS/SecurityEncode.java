...
public class SecurityEncode {
    ...
    public static void main(String[] args) {
			String encodeStr = SecurityEncode.encoderByDES("123456789", "123");
			System.out.println(encodeStr);//d87d04e348fdbbf67b9ef8d2bcd15268
			String decoderStr = SecurityEncode.decoderByDES("d87d04e348fdbbf67b9ef8d2bcd15268", "123");
